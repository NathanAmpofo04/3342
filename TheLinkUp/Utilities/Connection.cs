...
namespace Utilities
{
    public class DBConnect
    {
        ...
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp26_3342_tui13979;User id=tui13979;Password=Piey4oheed; TrustServerCertificate=true";

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=sp26_3342_tui13979;User id=tui13979;Password=Piey4oheed; TrustServerCertificate=true";
