...
namespace Utilities
{
    public class DBConnect
    {
        ...
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp26_3342_tup86303;User id=tup86303;Password=Ujoo4jaish; TrustServerCertificate=true";

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=sp26_3342_tuxNNNNN;User id=tuxNNNNN;Password=XXXXXX; TrustServerCertificate=true";
